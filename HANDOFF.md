...
> Review `PROJECT_CONTEXT.md`, `README.md`, `CHANGELOG.md` and the source code. Continue development from Version 3.2.1. Do not replace `js/config.js`, Supabase authentication, Akahu secrets or existing finance data unless I explicitly ask.
